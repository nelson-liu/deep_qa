...
class BidirectionalAttentionFlow(TextTrainer):
    ...
    def _build_model(self):
        ...
        # Shape: (batch_size, num_passage_words, embedding_size * 2)
        passage_question_vectors = WeightedSum(name="passage_question_vectors")([encoded_question, passage_question_attention])
        ...
        question_passage_vector = WeightedSum(name="question_passage_vector")([encoded_passage, question_passage_attention])
        ...
        # Shape: (batch_size, num_passage_words, embedding_size * 2)
        repeat_layer = Repeat(axis=1, repetitions=self.num_passage_words)
        passage_weighted_by_predicted_span = repeat_layer(WeightedSum(name="passage_span_begin_sum")([modeled_passage,
