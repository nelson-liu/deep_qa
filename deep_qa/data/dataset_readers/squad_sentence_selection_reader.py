...
class SquadSentenceSelectionReader():
    ...
    def read_file(self, input_filepath):
        # import is here because it is slow and not needed by default.
        import nltk
        processed_rows = []
        ...
        for article in tqdm(dataset):
            for paragraph in article['paragraphs']:
                ...
                for sentence in sentences:
                    ...
                    # need to add one to the end index to account for trailing
                    # space after punctuation that is stripped by NLTK.
                    span_to_sentence_idx[(current_index,
                ...
                for question_answer in paragraph['qas']:
                    ...
                    answer_start_idx = question_answer["answers"][0]["answer_start"]
                    # Get the full sentence corresponding to the answer
                    answer_sentence = None
                    for span_tup in span_to_sentence_idx:
                        start_span, end_span = span_tup
                        if start_span <= answer_start_idx and answer_start_idx < end_span:
                            answer_sentence = span_to_sentence_idx[span_tup]
                            break
                    ...
                    answer_idx = sentences.index(answer_sentence)
